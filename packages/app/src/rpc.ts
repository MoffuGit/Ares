...
import type { AppState, Settings, Theme, WorktreeEntry, ScopedKeymaps, Mode, Surface, BufferState, ProjectInfo } from "@ares/shared";
...
export type AppRPC = {
    bun: RPCSchema<{
        requests: {
            ...
            openProjectDialog: { params: {}; response: ProjectInfo | null };
    ...
    webview: RPCSchema<{
        ...
        messages: {
            ...
            projectUpdate: ProjectInfo | null;
