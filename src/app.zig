...
events: SinglyLinkedList(Event, "next"),
dispatched: SinglyLinkedList(Dispatched, "next"),
deferred: SinglyLinkedList(Deferred, "next"),
listeners: Listeners,
receivers: Receivers,
observers: Observers,
...
scheduler: Scheduler,
renderer: Renderer,
states: SinglyLinkedList(WindowState, "next"),
