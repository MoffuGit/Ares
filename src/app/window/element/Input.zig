...
//NOTE:
//Vaxis impl of a text input
//this text input should be capable of
//handling multi line text
//if there is something that i dont like of vim
//is how it handle extern changes to the files,
//this is a part i will like to improve,
//the improvements probably come from the undo tree,
//if an external change is made before you save,
//you can probably take some steps back inside the undo tree and find where it would be
//the best place for putting the text you didn't save,
//for that probably a treesitter could help
//lets check how zed to things
//one things is that the scroll should get hanlded from here already and not on an external element
//it should make more easy to work with the text input,
//then the editor view would be the one that handle the line numbers and the
//lsp errors and other things
//
// const std = @import("std");
// const assert = std.debug.assert;
