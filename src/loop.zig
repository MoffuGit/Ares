...
canceling: SinglyLinkedList(Completion, "next"),
submissions: SinglyLinkedList(Completion, "next"),
completions: SinglyLinkedList(Completion, "next"),
cancellations: SinglyLinkedList(Completion, "next"),
