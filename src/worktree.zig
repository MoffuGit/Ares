...
//         .scanner = undefined,
//         // .buffer = undefined,
//         // .updates = .init(&self.buffer),
//         // .scanner_waker = undefined,
//     };
//
...
//
//     self.scanner = try Scanner.create(self.gpa, &self.snapshot, io);
//     // const handler, _ = try ctx.await(handleUpdates, .{});
//     // errdefer self.handlers.cancel(io);
//     //
//     // self.handlers.add(io, handler);
//
//     // const scanner_handler, self.scanner_waker = try self.scanner.init(
//     //     ctx.gpa(),
//     //     self.snapshot,
//     //     self.updates,
//     //     ctx.executor(),
...
//     //     io,
//     // );
//     // errdefer self.scanner.deinit(ctx.gpa());
//     //
//     // self.handlers.add(io, scanner_handler);
//     //
//     // try self.scanner.actions.putOne(self.io, .initial_scan);
//     // try self.scanner_waker.wake();
// }
//
...
// //     _flushUpdates(ctx) catch return false;
// //
// //     return true;
// // }
// //
// // fn _flushUpdates(ctx: Context(Worktree)) !void {
// //     const self, const update = ctx.update();
// //     defer update.end(self);
// //
// //     // var buffer: [8]Updates = undefined;
// //     // for (0..try self.updates.get(self.io, &buffer, 0)) |idx| {
// //     //     switch (buffer[idx]) {
